...
class SocialController extends Controller
{
    ...
    public function contact() {
		$UserId = Auth::user()->id;
		$cdate = date("Y-m-d");
		$showRec = DB::table('contact_us')
			->select("contact_us.*")
			->get();
       
        return view('admin-views.social.contact', ['showRec' => $showRec]);
    }
    public function subscribe() {
		$UserId = Auth::user()->id;
		$cdate = date("Y-m-d");
		$showRec = DB::table('subscribers')
			->select("subscribers.*")
			->get();
       
        return view('admin-views.social.subscribe', ['showRec' => $showRec]);
    }
    public function add() {
		$UserId = Auth::user()->id;
		$cdate = date("Y-m-d");
