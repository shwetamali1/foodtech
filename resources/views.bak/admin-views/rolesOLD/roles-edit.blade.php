											...
											<div class="row">
												<div class="col-sm-6 col-md-6">
													<div class="form-group">
														...
														<input type="text" name="roles" class="form-control" placeholder="Role Name" value="{{$editRec->roles}}">
													...
													<div class="row">
														<?php
															...
															foreach($LeftMenu as $key=>$menu) {
																if(in_array($menu->id, $permissionIds)) {
																	$menuChecked = 'checked';
																} else {
																	$menuChecked = '';
																}
																		...
																		<li>
																			...
																			foreach($subMenuList as $submenu) { 
																				if($menu->id == $submenu->parent_id) {
																					if(in_array($submenu->id, $permissionIds)) {
