    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse text-center" id="navbarsExample07">
        <ul class="navbar-nav mb-2 mb-lg-0">
          <li class="nav-item">
            <a class="nav-link {{ request()->is('/') || request()->is('home') || request()->is('home2') ? 'active' : '' }}" aria-current="page" href="/home">Home</a>
          </li>
          <li class="nav-item">
            <a class="nav-link {{ request()->is('subscriptions') ? 'active' : '' }}" href="/subscriptions">Subscriptions</a>
          </li>
          <li class="nav-item">
            <a class="nav-link {{ request()->is('business-plans') || request()->is('business-plans/*') ? 'active' : '' }}" href="/business-plans">Food Business Plans</a>
          </li>
          <li class="nav-item">
