											...
											<div class="row">
												<div class="col-sm-6 col-md-6">
													<div class="form-group">
														...
														<input type="text" name="title" class="form-control" placeholder="menu title" value="{{$editRec->title}}">
												...
												<div class="col-sm-6 col-md-6">
													<div class="form-group">
														...
														<select name="parent_id" class="form-control select2">
															...
															<option value="<?= $parent->id; ?>" {{ $editRec->parent_id == $parent->id ? 'selected' : '' }} ><?= $parent->title; ?></option>
															<?php } ?>
														</select>
													</div>
												</div>
												<div class="col-sm-6 col-md-6">
													<div class="form-group">
														...
														<input type="text" name="url" class="form-control" placeholder="menu url" value="{{$editRec->url}}">
													</div>
												</div>
												<div class="col-sm-6 col-md-6">
													<div class="form-group">
														<label class="form-label">Use Controller</label>
														<input type="text" name="controller" class="form-control" placeholder="controller" value="{{$editRec->controller}}">
													</div>
												</div>
												<div class="col-sm-6 col-md-6">
													<div class="form-group">
														<label class="form-label">User Action Method</label>
														<input type="text" name="action" class="form-control" placeholder="action method" value="{{$editRec->action}}">
													</div>
												</div>
												<div class="col-sm-6 col-md-6">
													<div class="form-group">
														<label class="form-label">Menu Orders <span class="text-red">*</span></label>
														<input type="text" name="orders" class="form-control" placeholder="menu orders" value="{{$editRec->orders}}">
												...
												<div class="col-sm-6 col-md-6">
													<div class="form-group">
														...
														<input type="text" name="nav_item" class="form-control" placeholder="nav link" value="{{$editRec->nav_item}}">
												...
												<div class="col-sm-6 col-md-6">
													<div class="form-group">
														...
														<input type="text" name="menu_icon" class="form-control" placeholder="menu icon" value="{{$editRec->menu_icon}}">
													</div>
												</div>
												<div class="col-sm-6 col-md-6">
													<div class="form-group">
														<label class="form-label">Permission Tag</label>
														<input type="text" name="permission_tag" class="form-control" placeholder="permission" value="{{$editRec->permission_tag}}">
													</div>
												</div>
												<div class="col-sm-6 col-md-6">
													<div class="form-group">
														...
														<select name="is_submenu" class="form-control select2">
															<option value="Yes" {{ $editRec->is_submenu == 'Yes' ? 'selected' : '' }} >Yes</option>
															<option value="No" {{ $editRec->is_submenu == 'No' ? 'selected' : '' }} >No</option>
														</select>
													</div>
												</div>
											</div>
