                ...
                <div class="plan-form-card card mb-4">
                    ...
                    <div class="plan-form-header">
                        ...
                        <div>
                            ...
                            <p>Update plan details, pricing and features</p>
                        </div>
                    </div>
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="row g-3 mb-4">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="title" class="form-control" placeholder="e.g. Professional Plan" value="{{ old('title', $editRec->title) }}">
                                    @error('title')<span class="text-danger">{{ $message }}</span>@enderror
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label">Plan Offer <span class="req">*</span></label>
                                    <input type="text" name="offer" class="form-control" placeholder="e.g. 3 Months Free" value="{{ old('offer', $editRec->offer) }}">
                                    @error('offer')<span class="text-danger">{{ $message }}</span>@enderror
                                </div>
                                <div class="col-12">
                                    <label class="form-label">Description <span class="req">*</span></label>
                                    <input type="text" name="description" class="form-control" placeholder="Brief description of this plan" value="{{ old('description', $editRec->description) }}">
                            ...
                            <div class="row g-3 mb-4">
                                <div class="col-md-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="price" class="form-control" placeholder="0" value="{{ old('price', $editRec->price) }}">
                                    </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="input-group">
                                        <span class="input-prefix">₹</span>
                                        <input type="number" name="government_fee" class="form-control" placeholder="0" value="{{ old('government_fee', $editRec->government_fee) }}">
                                    </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="input-group">
                                        <input type="number" name="discount" class="form-control" placeholder="0" value="{{ old('discount', $editRec->discount) }}" style="border-radius:10px 0 0 10px !important;">
                                        <span class="input-prefix" style="border-left:none;border-right:1.5px solid #e4eaf2;border-radius:0 10px 10px 0;">%</span>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <label class="form-label">Credits</label>
                                    <input type="text" name="credits" class="form-control" placeholder="e.g. 100" value="{{ old('credits', $editRec->credits) }}">
                                </div>
                                <div class="col-md-4">
                                    <label class="form-label">Label Validations / Year</label>
                                    <input type="number" name="label_validation_limit" class="form-control" placeholder="Blank = unlimited" value="{{ old('label_validation_limit', $editRec->label_validation_limit) }}">
                                </div>
                            </div>
