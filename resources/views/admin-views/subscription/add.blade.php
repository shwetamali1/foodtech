@extends('layouts.master')
  ...
  @section('content')    
            <!--begin::Row-->
            <div class="row">
              <div class="col-sm-6"><h3 class="mb-0">Add Plan</h3></div>
              <div class="col-sm-6">
							...
							<div class="row g-3">
								<div class="col-6">
									<div class="form-group">
										...
										<input type="text" name="title" class="form-control" placeholder="Plan Title" value="{{old('title')}}">
								...
								<div class="col-6">
									<div class="form-group">
										...
										<input type="text" name="offer" class="form-control" placeholder="Plan Offer" value="{{old('offer')}}">
								...
								<div class="col-6">
									<div class="form-group">
										<label class="form-label">Plan Price <span class="text-red">*</span></label>
										<input type="text" name="price" class="form-control" placeholder="Plan Price" value="{{old('price')}}">
    ...
    <div class="form-group">
        ...
        <input type="number" name="government_fee" class="form-control" placeholder="Government Fee" value="{{ old('government_fee') }}">
        <span class="text-danger">{{ $errors->first('government_fee') }}</span>
								...
								<div class="col-6">
									<div class="form-group">
										...
										<input type="number" name="discount" class="form-control" placeholder="Discount Rate" value="{{old('discount')}}">
									</div>
								</div>
								<!--<div class="col-6">-->
								<!--	<div class="form-group">-->
								<!--		<label class="form-label">Per Month </label>-->
								<!--		<input type="text" name="per" class="form-control" placeholder="Per Month" value="{{old('per')}}">-->
								<!--	</div>-->
								<!--</div>-->
								<div class="col-6">
									<div class="form-group">
										<label class="form-label">Credits</label>
										<input type="text" name="credits" class="form-control" placeholder="Credits" value="{{old('credits')}}">
									</div>
								</div>
								...
								<div class="col-12">
									<div class="form-group">
										...
										<textarea name="features[]" class="form-control" rows="7"></textarea>
