             ...
             <div class="card">
              <div class="card-header">
                  ...
                  <div style="float:right">
                    <a class="btn btn-primary" href="{{URL::to('/category/add-report-category')}}">
                 + Add Category
                </a>
                  </div>
              </div>
                ...
                <table id="category" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="{{URL::to('/category/edit-report-category/'.$record->id)}}" class="icon-circle-list"><i class="bi bi-pencil" style="font-size: 18px;"></i></a>
                        <a href="{{URL::to('/category/delete-report-category/'.$record->id)}}" class="icon-circle-list" onclick="return confirm('Are you sure you want to delete')"><i class="bi bi-trash" style="font-size: 18px;"></i></a>
                      </td>
