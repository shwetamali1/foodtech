...
<div class="page-header-row">
  <div class="row align-items-center">
    <div class="col-sm-6">
      <h3><i class="bi bi-tags me-2" style="color:var(--ft-gold);"></i>Business Categories</h3>
    </div>
    <div class="col-sm-6">
...
<div class="container-fluid">
  ...
  <div class="card">
    <div class="card-header">
      ...
      <a class="btn-add" href="{{ URL::to('/category/add') }}">
          ...
          <tbody>
            ...
            @foreach($showRec as $record)
              <tr>
                ...
                <td>
                  <a href="{{ URL::to('/category/edit/'.$record->id) }}"
                     class="btn-icon btn-icon-edit" title="Edit">
                    <i class="bi bi-pencil-fill"></i>
                  </a>
                  <a href="{{ URL::to('/category/delete/'.$record->id) }}"
