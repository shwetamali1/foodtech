  ...
  @section('content')    
      <div class="app-content-header">
          ...
          <div class="container-fluid">
            <!--begin::Row-->
            <div class="row">
              <div class="col-sm-6"><h3 class="mb-0">Business Categories</h3></div>
              <div class="col-sm-6">
                ...
                <table id="category" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="{{URL::to('/category/edit/'.$record->id)}}" class="icon-circle-list"><i class="bi bi-pencil" style="font-size: 18px;"></i></a>
                        <a href="{{URL::to('/category/delete/'.$record->id)}}" class="icon-circle-list" onclick="return confirm('Are you sure you want to delete')"><i class="bi bi-trash" style="font-size: 18px;"></i></a>
                      </td>
