...
<div class="app-content-header">
  <div class="container-fluid">
    <div class="row align-items-center">
      <div class="col-sm-6"><h4 class="mb-0">Edit Document Category</h4></div>
      <div class="col-sm-6">
    ...
    <div class="cat-edit-wrap">
      ...
      <div class="cat-edit-card">
        <div class="cat-edit-header">
          <div class="cat-header-icon"><i class="bi bi-folder2-open"></i></div>
          <div>
            <h5>Edit Document Category</h5>
            <p>Update the document category name below</p>
          </div>
        </div>
