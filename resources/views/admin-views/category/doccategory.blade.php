...
<div class="page-header-row">
  <div class="row align-items-center">
    <div class="col-sm-6">
      <h3><i class="bi bi-folder2 me-2" style="color:var(--ft-gold);"></i>Document Categories</h3>
    </div>
    <div class="col-sm-6">
...
<div class="container-fluid">
  ...
  <div class="card">
    <div class="card-header">
      ...
      <a class="btn-add" href="{{ URL::to('/category/add-doc-category') }}">
          ...
          <tbody>
            ...
            @foreach($showRec as $record)
              <tr>
                <td>{{ $rowNum++ }}</td>
                <td>
                  <span class="fw-semibold" style="color:var(--ft-navy);">{{ $record->type }}</span>
                </td>
                <td>
                  <a href="{{ URL::to('/category/edit-doc-category/'.$record->id) }}"
                     class="btn-icon btn-icon-edit" title="Edit">
                    <i class="bi bi-pencil-fill"></i>
                  </a>
                  <a href="{{ URL::to('/category/delete-doc-category/'.$record->id) }}"
