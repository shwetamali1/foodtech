@extends('layouts.master')
  ...
  @section('content')    
            <!--begin::Row-->
            <div class="row">
              <div class="col-sm-6"><h3 class="mb-0">Add Business Category</h3></div>
              <div class="col-sm-6">
							...
							<div class="row g-3">
								<div class="col-6">
									<div class="form-group">
										...
										<input type="text" name="category" class="form-control" placeholder="Business Category" value="{{old('category')}}">
