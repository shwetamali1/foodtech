@extends('layouts.master')
  ...
  @section('content')    
            <!--begin::Row-->
        <div class="row">
              <div class="col-sm-6"><h3 class="mb-0">My Liecenses</h3></div>
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-end">
                  <li class="breadcrumb-item"><a href="#">Home</a></li>
                  <li class="breadcrumb-item active" aria-current="page">My Liecenses</li>
                </ol>
              </div>
            </div>
            <!--end::Row-->
            ...
            <div class="card">
              <div class="card-header p-2">
                <ul class="nav nav-pills">
                  <li class="nav-item"><a class="nav-link" href="#my_liencense" data-toggle="tab">My Licenses</a></li>
                </ul>
              </div><!-- /.card-header -->
              <div class="card-body">
