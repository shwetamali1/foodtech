@extends('layouts.master')
  ...
  @section('content')    
            <!--begin::Row-->
            <div class="row">
              <div class="col-sm-6"><h3 class="mb-0">Edit Reports</h3></div>
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-end">
                  <li class="breadcrumb-item"><a href="#">Home</a></li>
                  <li class="breadcrumb-item active" aria-current="page">Edit Reports</li>
                </ol>
              </div>
            </div>
            <!--end::Row-->
                  ...
                  <!--begin::Form-->
                    <form action="{{$editRec->id}}" method="post">
							...
							<div class="row g-3">
								<div class="col-12">
									<div class="form-group">
										...
										<input type="text" name="title" class="form-control" placeholder="FSSAI License Application" value="{{$editRec->reports_title}}">
								...
								<div class="col-12">
									<div class="form-group">
										...
										<input type="text" name="price" class="form-control" placeholder="FSSAI License Application Price" value="{{$editRec->price}}">
									...
									<div class="form-group">
										...
										<select id="category_id" name="category_id" class="form-control select2">
											...
											<?php foreach ($categories as $category) { ?>
											    <option <?php if($editRec->category_id == $category->id) { ?> selected <?php } ?> value="<?php echo $category->id ?>"><?php echo $category->category ?></option>
											<?php } ?>
										</select>
						...
						<div class="card-footer text-right">
							...
							<a href="{{URL::to('/reports/list/')}}" class="btn btn-danger">Cancel</a>
						</div>
					</form>
                  <!--end::Form-->
                </div>
