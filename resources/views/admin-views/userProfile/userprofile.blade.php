							...
							<div class="row">
										...
										<div class="widget-user-image1 d-sm-flex">
											<?php 
												if(!empty(auth()->user()->profile_image)) {
													$profileURL = 'profile_images/'.auth()->user()->profile_image;
												} else {
													$profileURL = 'profile_images/default_img.jpg';
												}
											?>
											<img alt="User Profile" class="rounded-circle border p-0" width="128" height="130" src="{{URL::asset($profileURL)}}">
											<div class="mt-1 ml-lg-5">
												<h4 class="pro-user-username mb-3 font-weight-bold"><?= auth()->user()->first_name .' '. auth()->user()->last_name ?> <i class="fa fa-check-circle text-success"></i></h4>
												<ul class="mb-0 pro-details">
													<li><span class="profile-icon"><i class="fe fe-mail"></i></span><span class="h6 mt-3"><?= auth()->user()->email; ?></span></li>
													<li><span class="profile-icon"><i class="fe fe-phone-call"></i></span><span class="h6 mt-3">+91 {{auth()->user()->phone_number}}</span></li>
								...
								<div class="col-lg-4 col-md-auto">
									<div class="text-lg-right btn-list mt-4 mt-lg-0">
										...
										<a href="edit-user-profile" class="btn btn-primary">Edit Profile</a>
									</div>
								</div>
							</div>
